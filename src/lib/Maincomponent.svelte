...
<path d="M17.75 6.25L6.25 17.75" stroke="{color}" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
	...
	{#if variant == 'bold'}
		<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M16.5098 5.01L14.5498 3.05C13.1498 1.65 10.8498 1.65 9.44977 3.05L7.48977 5.01C7.09977 5.4 7.09977 6.04 7.48977 6.43L11.2998 10.24C11.6898 10.63 12.3198 10.63 12.7098 10.24L16.5198 6.43C16.8998 6.04 16.8998 5.4 16.5098 5.01Z" fill="{color}"/>
<path d="M5.01 7.49172L3.05 9.45172C1.65 10.8517 1.65 13.1517 3.05 14.5517L5.01 16.5117C5.4 16.9017 6.03 16.9017 6.42 16.5117L10.23 12.7017C10.62 12.3117 10.62 11.6817 10.23 11.2917L6.43 7.49172C6.04 7.10172 5.4 7.10172 5.01 7.49172Z" fill="{color}"/>
<path d="M20.9491 9.45172L18.9891 7.49172C18.5991 7.10172 17.9691 7.10172 17.5791 7.49172L13.7691 11.3017C13.3791 11.6917 13.3791 12.3217 13.7691 12.7117L17.5791 16.5217C17.9691 16.9117 18.5991 16.9117 18.9891 16.5217L20.9491 14.5617C22.3491 13.1517 22.3491 10.8517 20.9491 9.45172Z" fill="{color}"/>
<path d="M7.48907 18.9891L9.44907 20.9491C10.8491 22.3491 13.1491 22.3491 14.5491 20.9491L16.5091 18.9891C16.8991 18.5991 16.8991 17.9691 16.5091 17.5791L12.6991 13.7691C12.3091 13.3791 11.6791 13.3791 11.2891 13.7691L7.47907 17.5791C7.09907 17.9591 7.09907 18.5991 7.48907 18.9891Z" fill="{color}"/>
</svg>
...
<path d="M17.7495 18.5C17.5595 18.5 17.3695 18.43 17.2195 18.28L5.71945 6.78C5.42945 6.49 5.42945 6.00994 5.71945 5.71994C6.00945 5.42994 6.48945 5.42994 6.77945 5.71994L18.2795 17.2199C18.5695 17.5099 18.5695 17.99 18.2795 18.28C18.1295 18.43 17.9395 18.5 17.7495 18.5Z" fill="{color}"/>
<path d="M6.24945 18.5C6.05945 18.5 5.86945 18.43 5.71945 18.28C5.42945 17.99 5.42945 17.5099 5.71945 17.2199L17.2195 5.71994C17.5095 5.42994 17.9895 5.42994 18.2795 5.71994C18.5695 6.00994 18.5695 6.49 18.2795 6.78L6.77945 18.28C6.62945 18.43 6.43945 18.5 6.24945 18.5Z" fill="{color}"/>
</svg>
