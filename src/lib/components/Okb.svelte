...
<path d="M12 12C14.7614 12 17 9.76142 17 7C17 4.23858 14.7614 2 12 2C9.23858 2 7 4.23858 7 7C7 9.76142 9.23858 12 12 12Z" stroke="{color}" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M7 17C9.76142 17 12 14.7614 12 12C12 9.23858 9.76142 7 7 7C4.23858 7 2 9.23858 2 12C2 14.7614 4.23858 17 7 17Z" stroke="{color}" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
...
<path d="M12 12C12 9.24 14.24 7 17 7C17 4.24 14.76 2 12 2C9.24 2 7 4.24 7 7C9.76 7 12 9.24 12 12Z" fill="{color}"/>
<path d="M12 12C9.24 12 7 9.76 7 7C4.24 7 2 9.24 2 12C2 14.76 4.24 17 7 17C7 14.24 9.24 12 12 12Z" fill="{color}"/>
</svg>
...
<path d="M12 22C14.7614 22 17 19.7614 17 17C17 14.2386 14.7614 12 12 12C9.23858 12 7 14.2386 7 17C7 19.7614 9.23858 22 12 22Z" stroke="{color}" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M12 12C14.7614 12 17 9.76142 17 7C17 4.23858 14.7614 2 12 2C9.23858 2 7 4.23858 7 7C7 9.76142 9.23858 12 12 12Z" stroke="{color}" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M2.81 9.27C2.3 10.06 2 10.99 2 12C2 14.76 4.24 17 7 17C9.76 17 12 14.76 12 12C12 9.24 9.76 7 7 7C6.65 7 6.31999 7.03 5.98999 7.1" stroke="{color}" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
...
<path fill="{color}" opacity="0.4" d="M22.667 22.667c0 3.68-2.987 6.667-6.667 6.667s-6.667-2.987-6.667-6.667c3.68 0 6.667-2.987 6.667-6.667 0 3.68 2.987 6.667 6.667 6.667z"></path>
<path fill="{color}" d="M22.667 9.333c0 3.68-2.987 6.667-6.667 6.667 0-3.68 2.987-6.667 6.667-6.667z"></path>
<path fill="{color}" opacity="0.4" d="M22.667 9.333c-3.68 0-6.667 2.987-6.667 6.667 0-3.68-2.987-6.667-6.667-6.667 0-3.68 2.987-6.667 6.667-6.667s6.667 2.987 6.667 6.667z"></path>
<path fill="{color}" d="M16 16c0 3.68-2.987 6.667-6.667 6.667 0-3.68 2.987-6.667 6.667-6.667z"></path>
<path fill="{color}" d="M16 16c-3.68 0-6.667-2.987-6.667-6.667 3.68 0 6.667 2.987 6.667 6.667z"></path>
<path fill="{color}" opacity="0.4" d="M16 16c-3.68 0-6.667 2.987-6.667 6.667-3.68 0-6.667-2.987-6.667-6.667s2.987-6.667 6.667-6.667c0 3.68 2.987 6.667 6.667 6.667z"></path>
</svg>
...
<path d="M7 17.75C3.83 17.75 1.25 15.17 1.25 12C1.25 8.83 3.83 6.25 7 6.25C10.17 6.25 12.75 8.83 12.75 12C12.75 15.17 10.17 17.75 7 17.75ZM7 7.75C4.66 7.75 2.75 9.66 2.75 12C2.75 14.34 4.66 16.25 7 16.25C9.34 16.25 11.25 14.34 11.25 12C11.25 9.66 9.34 7.75 7 7.75Z" fill="{color}"/>
</svg>
