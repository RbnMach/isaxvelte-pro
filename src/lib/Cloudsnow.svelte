...
<path d="M13.47 14.3906H10.53C9.26 14.3906 8.5 15.1506 8.5 16.4206V19.3606C8.5 20.6306 9.26 21.3906 10.53 21.3906H13.47C14.74 21.3906 15.5 20.6306 15.5 19.3606V16.4206C15.5 15.1506 14.74 14.3906 13.47 14.3906ZM10.5 17.6306C10.08 17.6306 9.75 17.2906 9.75 16.8806C9.75 16.4706 10.08 16.1306 10.5 16.1306C10.92 16.1306 11.25 16.4706 11.25 16.8806C11.25 17.2906 10.91 17.6306 10.5 17.6306ZM12 19.8806C11.59 19.8806 11.25 19.5406 11.25 19.1306C11.25 18.7206 11.59 18.3806 12 18.3806C12.41 18.3806 12.75 18.7206 12.75 19.1306C12.75 19.5406 12.42 19.8806 12 19.8806ZM13.51 17.6306C13.09 17.6306 12.76 17.2906 12.76 16.8806C12.76 16.4706 13.09 16.1306 13.51 16.1306C13.93 16.1306 14.26 16.4706 14.26 16.8806C14.26 17.2906 13.92 17.6306 13.51 17.6306Z" fill="{color}"/>
</svg>
...
<path d="M13.47 14.3899H10.53C9.26 14.3899 8.5 15.1499 8.5 16.4199V19.3599C8.5 20.6299 9.26 21.3899 10.53 21.3899H13.47C14.74 21.3899 15.5 20.6299 15.5 19.3599V16.4199C15.5 15.1499 14.74 14.3899 13.47 14.3899ZM10.5 17.6299C10.08 17.6299 9.75 17.2899 9.75 16.8799C9.75 16.4699 10.08 16.1299 10.5 16.1299C10.92 16.1299 11.25 16.4699 11.25 16.8799C11.25 17.2899 10.91 17.6299 10.5 17.6299ZM12 19.8799C11.59 19.8799 11.25 19.5399 11.25 19.1299C11.25 18.7199 11.59 18.3799 12 18.3799C12.41 18.3799 12.75 18.7199 12.75 19.1299C12.75 19.5399 12.42 19.8799 12 19.8799ZM13.51 17.6299C13.09 17.6299 12.76 17.2899 12.76 16.8799C12.76 16.4699 13.09 16.1299 13.51 16.1299C13.93 16.1299 14.26 16.4699 14.26 16.8799C14.26 17.2899 13.92 17.6299 13.51 17.6299Z" fill="{color}"/>
</svg>

	{/if}										
	{#if variant == 'outline'}
		<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M16.6495 20.75C16.6395 20.75 16.6195 20.75 16.6095 20.75C16.1995 20.75 15.8595 20.41 15.8695 19.99C15.8695 19.58 16.2395 19.21 16.6295 19.25C17.7295 19.25 18.8895 18.83 19.7395 18.05C21.2895 16.69 21.3995 14.75 20.9795 13.38C20.5595 12.01 19.3895 10.46 17.3695 10.2C17.0395 10.16 16.7795 9.91001 16.7195 9.58001C16.3295 7.19001 15.0295 5.54001 13.0895 4.94001C11.0695 4.32001 8.73949 4.93001 7.27949 6.46001C5.85949 7.95002 5.52949 10.02 6.34949 12.31C6.48949 12.7 6.28949 13.13 5.89949 13.27C5.50949 13.41 5.07949 13.21 4.93949 12.82C3.92949 10.01 4.38949 7.32001 6.19949 5.43001C8.04949 3.50001 10.9895 2.73001 13.5395 3.52001C15.8695 4.24001 17.5195 6.16001 18.1095 8.82001C20.1495 9.28001 21.7795 10.82 22.4295 12.95C23.1395 15.27 22.4995 17.65 20.7595 19.17C19.6095 20.19 18.1595 20.75 16.6495 20.75Z" fill="{color}"/>
<path d="M5.57008 20.7501C5.55008 20.7501 5.53008 20.7501 5.52008 20.7501C2.64008 20.5501 1.33008 18.2901 1.33008 16.2801C1.33008 14.2701 2.64008 12.0201 5.52008 11.8101C6.28008 11.8201 6.99008 11.9701 7.63008 12.2901C8.00008 12.4801 8.14008 12.9301 7.96008 13.3001C7.77008 13.6701 7.32008 13.8101 6.95008 13.6301C6.53008 13.4101 6.06008 13.3101 5.59008 13.3101C3.70008 13.4501 2.84008 14.9001 2.84008 16.2801C2.84008 17.6601 3.70008 19.1101 5.63008 19.2501C6.04008 19.2801 6.35008 19.6401 6.33008 20.0501C6.29008 20.4501 5.96008 20.7501 5.57008 20.7501Z" fill="{color}"/>
<path d="M15.8206 10.64C15.5406 10.64 15.2806 10.49 15.1506 10.22C14.9606 9.84997 15.1106 9.39997 15.4906 9.20997C16.1006 8.89997 16.7906 8.72997 17.4706 8.71997H17.4806C17.8906 8.71997 18.2206 9.04997 18.2306 9.45997C18.2406 9.86997 17.9106 10.22 17.4906 10.22C17.0306 10.23 16.5706 10.34 16.1506 10.55C16.0406 10.62 15.9306 10.64 15.8206 10.64Z" fill="{color}"/>
<path d="M12.9805 19C12.4205 19 11.9805 18.55 11.9805 18C11.9805 17.45 12.4305 17 12.9805 17C13.5305 17 13.9805 17.45 13.9805 18C13.9805 18.55 13.5305 19 12.9805 19Z" fill="{color}"/>
<path d="M8.98047 19C8.42047 19 7.98047 18.55 7.98047 18C7.98047 17.45 8.43047 17 8.98047 17C9.53047 17 9.98047 17.45 9.98047 18C9.98047 18.55 9.53047 19 8.98047 19Z" fill="{color}"/>
<path d="M10.9805 22C10.4205 22 9.98047 21.55 9.98047 21C9.98047 20.45 10.4305 20 10.9805 20C11.5305 20 11.9805 20.45 11.9805 21C11.9805 21.55 11.5305 22 10.9805 22Z" fill="{color}"/>
</svg>
